...
import { createServiceBook, getServiceBooks, updatePricebook, createCategory, updateCategory, deleteCategory, createServiceItem, getServiceItemsByCategoryId, updateServiceItem, deleteServiceItem, deleteServiceBook } from "../controllers/service.controller";
...
router.delete('/delete-service-book', requireAuth, requireRole('admin'), deleteServiceBook);
