  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 min-w-0">
        <span className="font-bold text-h6 block truncate text-neutral-800" title={displayTitle}>
          {displayTitle}
        </span>
        
        <div className="md:mt-2">
          <span className="text-p font-bold block truncate text-neutral-800" title={startTimeLabel}>
            {startTimeLabel}
          </span>
        </div>
      </div>
